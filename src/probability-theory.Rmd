...
Likelihood school, Fisherian inference, Neymar-Pearson mix-up
...
when it comes to inference following one of the different schools of thought 
can lead to incogruent conceptualizations: 
the [Likelihood school](https://en.wikipedia.org/wiki/Likelihoodist_statistics), 
[Fisherian significance testing framework, and Neymar-Pearson's hypothesis testing framework](https://en.wikipedia.org/wiki/Foundations_of_statistics)
