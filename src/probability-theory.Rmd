...
Optional stopping if [treated carefully](https://statmodeling.stat.columbia.edu/2014/02/13/stopping-rules-bayesian-analysis/), regularization, "multiple imputation?" are taken care of by default with Bayesian inference
