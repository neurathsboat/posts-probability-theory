...
we seek to calculate the plausibility of their conjuction, $AB$,
...
if $A$ is true not-$A$, or $\overline{A}$, must be false, and reversely.
...
leads to adoption of Bayesian inference
...
mostly revolving around computational efficiency.
