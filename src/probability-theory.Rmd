...
A machine, to avoid going into the subjective/objective debate: if you have information, the machine would benefit to use it, no matter what we call it.
Plausible reasoning
Reference to common sense is not to say that common sense is supreme, but rather that if our conclusions are disaggree with some very basic desiderata we should discard the conclusions and the process that lead us to them.
