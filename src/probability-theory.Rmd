...
Jaynes's thesis [REF] was that probability theory can be viewed as
...
The usage of "common sense" in the opening statement does not imply that 
...
or otherwise misinterpret them
[https://www.jstor.org/stable/1403453,
...
{{< figure src="https://raw.githubusercontent.com/chi-feng/mcmc-demo/master/docs/hmc.gif" title="Testing caption" lightbox="true" >}}
...
patently disagree: multiple comparisons, sequential testing, 
and finite population sampling [https://www2.stat.duke.edu/~berger/papers/interplay.pdf].

In summary, probability theory as extended logic,
or simply Bayesian inference as it is often called,
is a far-reaching theory that extends the reach of binary logic
